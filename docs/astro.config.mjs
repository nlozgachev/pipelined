		...
		starlight({
			...
			sidebar: [{
				...
				items: [
					...
					{ label: "Thinking in pipelines", slug: "basics/pipelines" },
					{ label: "What you will learn", slug: "basics/overview" },
					{ label: "Composition utilities", slug: "basics/composition" },
				],
			}, {
				...
				items: [
					...
					{ label: "Validation — collecting errors", slug: "guides/validation" },
				...
				items: [
					...
					{ label: "RemoteData — loading states", slug: "guides/remote-data" },
					{ label: "Resource — safe acquire-release", slug: "guides/resource" },
				],
			}, {
				label: "State & context",
				collapsed: false,
				items: [{ label: "Reader — deferred dependencies", slug: "guides/reader" }, {
					label: "State — threading state",
					slug: "guides/state",
				}, { label: "Logged — values with logs", slug: "guides/logged" }],
			}, {
				label: "Nested data",
				collapsed: false,
				items: [{ label: "Lens — nested updates", slug: "guides/lens" }, {
				...
				collapsed: false,
				items: [
					{ label: "Equality — custom equality", slug: "guides/equality" },
					{ label: "Ordering — typed comparators", slug: "guides/ordering" },
					{ label: "Combinable — combining values", slug: "guides/combinable" },
				...
				label: "Appendix",
				items: [{ label: "Why this exists", slug: "appendix/motivation" }, {
