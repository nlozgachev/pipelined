...
<CardGrid stagger>
  ...
  <Card title="Zero Jargon, Zero Dependencies">
    Built for TypeScript developers who want rock-solid safety without category-theory gatekeeping. Plain discriminated unions, zero external dependencies, 100% tree-shakeable, and optimized algorithms that outperform standard native methods.
  </Card>
</CardGrid>
